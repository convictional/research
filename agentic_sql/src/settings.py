...
color_formatter = colorlog.ColoredFormatter(
    ...
    secondary_log_colors={
        "message": {"DEBUG": "cyan", "INFO": "white", "WARNING": "yellow", "ERROR": "red", "CRITICAL": "red"}
    },
)
...
logging.getLogger("agentic_sql.bigquery_context").setLevel(logging.DEBUG)
logging.getLogger("agentic_sql.llm").setLevel(logging.DEBUG)
logging.getLogger("agentic_sql.main").setLevel(logging.INFO)
