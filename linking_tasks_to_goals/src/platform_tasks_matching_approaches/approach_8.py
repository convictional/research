...
GOAL_KEYWORDS_OUTPUT_PATH = settings.output_path / "approach_8_goal_keywords.pkl"
TASK_KEYWORDS_OUTPUT_PATH = settings.output_path / "approach_8_task_keywords.pkl"
GOAL_ENTITIES_OUTPUT_PATH = settings.output_path / "approach_8_goal_entities.pkl"
TASK_ENTITIES_OUTPUT_PATH = settings.output_path / "approach_8_task_entities.pkl"
GOAL_KEYWORDS_EMBEDDINGS_OUTPUT_PATH = settings.output_path / "approach_8_goal_keywords_embeddings.pkl"
TASK_KEYWORDS_EMBEDDINGS_OUTPUT_PATH = settings.output_path / "approach_8_task_keywords_embeddings.pkl"
GOAL_ENTITIES_EMBEDDINGS_OUTPUT_PATH = settings.output_path / "approach_8_goal_entities_embeddings.pkl"
TASK_ENTITIES_EMBEDDINGS_OUTPUT_PATH = settings.output_path / "approach_8_task_entities_embeddings.pkl"
TASK_MATCH_RESULTS_CSV_OUTPUT_PATH = settings.output_path / "approach_8_results.csv"
...
async def approach_8(goals: list[Goal], tasks: list[Task], load_embeddings_from_cache: bool):
    """
    Approach 8 for matching platform tasks to goals.
    ...
    """
    print("Starting matching platform tasks to goals using Approach 8...")
...
async def get_keywords(
    ...
    system_prompt = build_prompt("approach_8_goal_keywords_system.txt.jinja")
    user_prompts = [build_prompt("approach_8_goal_keywords_user.txt.jinja", goal=goal) for goal in goals]
    ...
    system_prompt = build_prompt("approach_8_task_keywords_system.txt.jinja")
    user_prompts = [build_prompt("approach_8_task_keywords_user.txt.jinja", task=task) for task in tasks]
...
async def get_entities(
    ...
    system_prompt = build_prompt("approach_8_goal_entities_system.txt.jinja")
    user_prompts = [build_prompt("approach_8_goal_entities_user.txt.jinja", goal=goal) for goal in goals]
    ...
    system_prompt = build_prompt("approach_8_task_entities_system.txt.jinja")
    user_prompts = [build_prompt("approach_8_task_entities_user.txt.jinja", task=task) for task in tasks]
...
async def do_llm_as_a_judge_evaluations(augmented_tasks: list[AugmentedTask]) -> list[AugmentedTask]:
    ...
    for i, task in enumerate(augmented_tasks):
        ...
        system_prompt = build_prompt("approach_8_llmaaj_system.txt.jinja")
        user_prompts = [
            build_prompt("approach_8_llmaaj_user.txt.jinja", task=task, goal=goal) for goal in embedding_filtered_goals
        ]
