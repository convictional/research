...
def create_final_project_objects(
    content_data: list[GitHubSourceContent],
    ...
    projects = [
        HighLevelResearchAndDevelopmentProject(
            ...
            source_content_urls="\n".join(
                [f"https://github.com/{content_id}" for content_id in project.source_content_ids]
            ),
...
def get_project_start(content_data: list[GitHubSourceContent], source_content_ids: list[str]) -> datetime:
    """
...
def get_project_end(content_data: list[GitHubSourceContent], source_content_ids: list[str]) -> datetime:
    """
...
def create_final_projects(content_data: list[GitHubSourceContent]):
    """
