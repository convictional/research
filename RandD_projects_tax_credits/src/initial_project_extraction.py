...
from .models import GitHubSourceContent, ResearchAndDevelopmentProject, ResearchAndDevelopmentProjects
...
async def initial_fine_grained_project_extraction(
    content_data: list[GitHubSourceContent], max_concurrent_tasks: int = 30, delay_between_tasks: float = 0.1
):
    """
