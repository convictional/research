...
Results are posted in the Convictional Task [internal app task, not public] for this analysis.

The write-up for this work lives in an internal Google Doc that is not public.
